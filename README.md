...
# 📖 One way React ROR API <a name="about-project"></a>

**One way React ROR API** is a frontend  for a displaying random greetings.
...
```sh
 https://github.com/RitaDee/one_way_react_ror.git
```
...
```sh
  cd your-folder
  git clone https://github.com/RitaDee/one_way_react_ror.git
```
...
Feel free to check the [issues page](https://github.com/RitaDee/one_way_react_ror/issues).
